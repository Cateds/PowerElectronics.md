...
因此反向峰值电压此时同时由两个二极管分担。每个二极管需要承受的电压是 $V_{AC}$，因为是等效反向接入电源。
...
较大的电流会导致额外的发热，计算是 $I^2t$，被称为**允通能量 (Let-throught Energy)**，其与电流的平方成正比，与时间成反比，因此 $10A$ 持续 $10ms$ 和 $100A$ 持续 $1ms$ 的发热损耗的比例是 $1:10$
